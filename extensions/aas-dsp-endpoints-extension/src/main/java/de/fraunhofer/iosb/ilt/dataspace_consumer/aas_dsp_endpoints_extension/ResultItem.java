 ...
 * @param dspEndpoint DSP endpoint (URL) to which access requests for this asset should be sent
 * @param assetURL HTTP href that can be used with a GateRequest to retrieve the asset content
 * @param interfaceType interface type or descriptor (e.g. indicates submodel vs. asset or transport
 *     interface)
 */
public record ResultItem(
        String assetId, String dspEndpoint, String assetURL, String interfaceType) {}
